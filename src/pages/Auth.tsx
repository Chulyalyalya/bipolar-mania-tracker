    ...
    async (data: {email: string;password: string;fullName: string;role: AppRole;}) => {
      ...
      try {
        ...
        if (result.session && result.user) {
          // Auto-confirmed: triggers already created profile + user_roles + doctor_code
    ...
    <Shell>
      <div className="space-y-6">
        <div className="flex items-baseline justify-between">
          <h1 className="text-xl font-semibold text-foreground tracking-tight">Bipolar Tracker</h1>
