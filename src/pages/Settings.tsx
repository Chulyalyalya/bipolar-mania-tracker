            ...
            <div className="flex items-center gap-1.5">
              ...
              <Popover>
                ...
                <PopoverContent className="w-72 text-xs leading-relaxed">
                  Подключённый врач видит Ваши оценки по блокам и может выгружать их.
                  <br /><br />
                  Также врач видит данные о приёме фармакологии: препараты, дозировки и отметки утро/вечер.
                  <br /><br />
                  Заметки врач не видит — это Ваш личный дневник.
                </PopoverContent>
              </Popover>
            </div>
